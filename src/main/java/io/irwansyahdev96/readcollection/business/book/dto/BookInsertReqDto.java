...
public class BookInsertReqDto {
    ...
    private List<CategoryInsertBookReqDto> categories;
    ...
    public List<CategoryInsertBookReqDto> getCategories() {
        return categories;
    }

    public void setCategories(List<CategoryInsertBookReqDto> bookType) {
        this.categories = bookType;
    }
